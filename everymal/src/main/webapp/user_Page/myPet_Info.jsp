  ...
  <%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
    ...
    <% request.setCharacterEncoding("utf-8"); %>
      ...
      <head>
        ...
        <link rel="stylesheet" href="${contextPath}/css/mypet_info.css" />
          ...
          function init() {
            if (${empty isLogon }) {
              ...
              if (${empty user_code }) {
                ...
                document.location.href = "${contextPath}/hosmy.jsp";
              }
            }
          }
            ...
            <div class="tabcontents">
              ...
              <div id="tabBox">
                  ...
                  <c:when test="${!empty petList}">
                    <c:forEach var="petinfo" items="${petList}">
                      ...
                      <div class="myPetInfoTitle">
                        ...
                        <form action="${contextPath}/petinfo/modPet.do" name="myPetInfoForm" class="myPetInfoForm"
                          method="post">
                          <fieldset>
                            <legend>내 반려동물 정보 수정 폼</legend>
                            <button type="button" class="delBtn"
                              onclick="delPetInfo('${contextPath}/petinfo/removePetInfo.do', '${petinfo.pet_code}')">- 펫
                              삭제
                            </button>
                ...
                <div class="myPetInfoTitle" style="display:none;" id="petInsert">
                  <div class="inputBck"></div>
                  <form action="${contextPath}/petinfo/addPet.do" name="myPetInfoForm" class="myPetInfoForm"
                    method="post">
                    <fieldset>
