      ...
      <head>
        ...
        <script type="text/javascript">
          ...
          function fil_paging(obj, section, page) {
            obj.action = "${contextPath}/hosfilter/listHos.do?section=" + section + "&pageNum=" + page;
            obj.submit();
          }
        </script>
        <link rel="stylesheet" href="${contextPath}/css/reset.css" />
        <link rel="stylesheet" href="${contextPath}/css/common.css" />
        <link rel="stylesheet" href="${contextPath}/css/hoslist.css" />
      </head>
      ...
      <body onload="init();">
        <div id="container">
          ...
          <section id="filter_Area">
            ...
            <form id="filterForm" name="filterForm" action="${contextPath}/hosfilter/listHos.do" method="post"
              class="overform">
              <fieldset>
                ...
                <c:choose>
                  <c:when test="${!empty hosList}">
                    <c:forEach var="hos" items="${hosList}">
                      ...
                      <li class="hp_con">
                        <a href="${contextPath}/hospital/Hospital_detail.do?hos_code=${hos.hos_code}" class="">
                          <img src="${contextPath}/hosThumDown.do?hos_thum=${hos.hos_thum}&hos_code=${hos.hos_code}"
