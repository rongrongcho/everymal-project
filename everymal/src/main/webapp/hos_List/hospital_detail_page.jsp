    ...
    <%@ taglib prefix="fmt" uri="http://java.sun.com/jsp/jstl/fmt" %>
      <%@ taglib prefix="fn" uri="http://java.sun.com/jsp/jstl/functions" %>
        ...
        <head>
          ...
          <link rel="stylesheet" type="text/css" href="${contextPath}/css/hospital_detail.page.css" />
            ...
            <div class="contentArea">
              ...
              <section id="hospitalInfo">
                ...
                <div id="infoDetail">
                  ...
                  <div class="tel fast_contact"><a href="#" onclick="cliptel();"><img src="${contextPath }/img/tel.png"
              ...
              <section id="review">
                ...
                <div class="reviewCanvas">
                      ...
                      <c:when test="${!empty hosReviewList}">
                        <c:forEach var="hosreview" items="${hosReviewList}">
                          <div class="review_box">
                            <a href="${contextPath}/hosReview/viewReview.do?rv_code=${hosreview.rv_code}"
                              class="review_list">
                              <p class="star">
                                <c:choose>
                  ...
                  <div class="left_right_control_panel">
                    <img class="left_btn" src="${contextPath }/img/left_btn.png" alt="왼쪽버튼">
                    <img class="right_btn" src="${contextPath }/img/right_btn.png" alt="오른쪽버튼">
                  </div>
                </div>
