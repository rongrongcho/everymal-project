  ...
  <%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %> <!-- core라이브러리를 c라는 접두사를 따와서 쓰겠다 -->
    ...
    <% request.setCharacterEncoding("utf-8"); %>
      ...
      <head>
        ...
        <link rel="stylesheet" href="${contextPath}/css/hosReview.css?ver=1" />
          ...
          <section id="tab_Area">
            ...
            <div class="tabcontents">
              <div id="tabBox" class="tab-content">
                ...
                <form action="${contextPath}/hosReview/hosRevDel.do" method="post" id="hosreviewListForm">
                  <div class="tableBox">
                            ...
                            <tr>
                              ...
                              <td>
                                <div class="text-ellipsis"><a class="res_code"
                                    href="${contextPath}/hosReview/viewReview.do?rv_code=${hosreview.rv_code}">${hosreview.rv_title}</a>
                                </div>
                              </td>
                        ...
                        <c:forEach var="page" begin="1" end="${tot-(section-1)*5}" step="1">
                          ...
                          <c:if test="${not doneLoop}">
                            <c:if test="${section>1 && page==1 }">
                              <a
                                href="${contextPath}/hosReview/hosReviewList.do?section=${section-1}&pageNum=${pageNum}">
                                prev</a>
                            </c:if>
                            <c:choose>
                              ...
                              <c:when test="${page==pageNum}">
                                <a class="selPage"
                                  href="${contextPath}/hosReview/hosReviewList.do?section=${section}&pageNum=${page}">${(section-1)*5+page}</a>
                              </c:when>
                              <c:otherwise>
                                <a class="noLine"
                                  href="${contextPath}/hosReview/hosReviewList.do?section=${section}&pageNum=${page}">${(section-1)*5+page}</a>
                      ...
                      <c:when test="${totReview <= 50 }">
                        ...
                        <c:forEach var="page" begin="1" end="${tot}" step="1">
                          <c:choose>
                            <c:when test="${page==pageNum}">
                              <a class="selPage"
                                href="${contextPath}/hosReview/hosReviewList.do?section=${section}&pageNum=${page}">${page}</a>
                            </c:when>
                            <c:otherwise>
                              <a class="noLine"
                                href="${contextPath}/hosReview/hosReviewList.do?section=${section}&pageNum=${page}">${page}</a>
