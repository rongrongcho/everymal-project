  ...
  <%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
    ...
    <% request.setCharacterEncoding("utf-8"); %>
      ...
      <head>
        ...
        <link rel="stylesheet" href="${contextPath}/css/hosMyReply.css?ver=12" />
          ...
          <section id="tab_Area">
            <div class="tab_nav">
              <ul class="tab_Btns">
                ...
                <li class="tBtn tBtn4 choiceTabNav"><a href="${contextPath }/hosReply/listMyReply.do"><span
            ...
            <div class="tabcontents">
              <div id="tabBox" class="tab-content">
                ...
                <form action="${contextPath}/hosReply/hosReplyDel.do" method="get" id="replyListForm"
                  name="replyListForm">
                        ...
                        <c:when test="${!empty replyList}">
                          <c:forEach var="reply" items="${replyList}">
                            <tr>
                              ...
                              <td><a class="a_code" href="${contextPath}/hosReply/viewReply.do?a_code=${reply.a_code}">
                                  ${reply.a_code}</a>
                              <td>
                                <div class="text-ellipsis"><a
                                    href="${contextPath}/hosReply/viewReply.do?a_code=${reply.a_code}">${reply.a_title}</a>
                                </div>
                              </td>
                        ...
                        <c:forEach var="page" begin="1" end="${tot-(section-1)*5}" step="1">
                          ...
                          <c:if test="${not doneLoop}">
                            <c:if test="${section>1 && page==1 }">
                              <a href="${contextPath}/hosReply/listMyReply.do?section=${section-1}&pageNum=${pageNum}">
                                prev</a>
                            </c:if>
                            <c:choose>
                              ...
                              <c:when test="${page==pageNum}">
                                <a class="selPage"
                                  href="${contextPath}/hosReply/listMyReply.do?section=${section}&pageNum=${page}">${(section-1)*5+page}</a>
                              </c:when>
                              <c:otherwise>
                                <a class="noLine"
                                  href="${contextPath}/hosReply/listMyReply.do?section=${section}&pageNum=${page}">${(section-1)*5+page}</a>
                      ...
                      <c:when test="${totReply <= 50 }">
                        ...
                        <c:forEach var="page" begin="1" end="${tot}" step="1">
                          <c:choose>
                            <c:when test="${page==pageNum}">
                              <a class="selPage"
                                href="${contextPath}/hosReply/listMyReply.do?section=${section}&pageNum=${page}">${page}</a>
                            </c:when>
                            <c:otherwise>
                              <a class="noLine"
                                href="${contextPath}/hosReply/listMyReply.do?section=${section}&pageNum=${page}">${page}</a>
