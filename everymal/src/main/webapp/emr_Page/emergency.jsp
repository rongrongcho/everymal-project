  ...
  <%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
    ...
    <% request.setCharacterEncoding("utf-8"); %>
      ...
      <head>
        ...
        <link rel="stylesheet" href="${contextPath}/css/emergency.css" />
      ...
      <body>
        <div id="container_sub">
          ...
          <section class="content">
            <img class="sirenImg" src="${contextPath}/img/siren1.png" alt="사이렌" />
            <div class="map_wrap">
              <div id="map" style="
              width: 100%;
              height: 100%;
         ...
         <script type="text/javascript"
            ...
            setInterval(function () {
              ...
              $(".sirenImg").attr("src", "${contextPath}/img/siren" + num + ".png");
            }, 1000);
          </script>
        </div>
      </body>
