                ...
                <div class="insertArea">
                  <div class="userInsertBox">
                    ...
                    <div class="taxiInfoBox">
                      ...
                      <img class="taxiDriverImg framed" src="${contextPath}/img/taxi_de.jpg" alt="기사님 사진 들어갈 자리"><br>
                      <div class="form-group taxi_info">
                        <span>기사 이름</span>
                        <input class="form-field" type="text" name="tx_name" placeholder="홍길동" readonly>
                        <input type="hidden" name="tx_name" />
                      </div>
                      <div class="form-group taxi_info">
                        <span>택시 번호</span>
                        <input class="form-field" type="text" name="tx_number" readonly>
                        <input type="hidden" name="tx_number" />
                      </div>
                      <div class="form-group taxi_info">
                        <span>연락처</span>
                        <input class="form-field" type="text" name="tx_tel" placeholder="1234" readonly>
