                ...
                <div class="tabcontents">
                  <div id="tabBox" class="tab-content">
                    ...
                    <form method="post" id="myhospital_info_form" name="frmHosinfo"
                      action="${contextPath }/hosMypageInfo/modmyHosInfo.do">
                      ...
                      <div class="apphosYorN">
                        ...
                        <c:choose>
                          <c:when test="${hosmypageinfoVO.hos_status == '승인'}">
                            <div class="yOrNo">
                              <p>승인된 병원 입니다.</p>
                              <a href="${contextPath }/app/viewMyApp.do?hos_code=${hos_code}" class="barogagy">썸네일
                                수정</a>
                            </div>
                          </c:when>
                          <c:when test="${hosmypageinfoVO.hos_status == '미승인'}">
                            <div class="yOrNo">
                              <p>미승인된 병원 입니다.</p>
                              <a href="${contextPath }/app/viewMyApp.do?hos_code=${hos_code}" class="barogagy">등록 신청</a>
                            </div>
                          </c:when>
                          <c:when test="${hosmypageinfoVO.hos_status == '거절'}">
                            <div class="yOrNo">
                              <p>등록 거절되었습니다.</p>
                              <a href="${contextPath }/app/viewMyApp.do?hos_code=${hos_code}" class="barogagy">사유확인</a>
                            </div>
                          </c:when>
                          <c:otherwise>
                            <div class="yOrNo">
                              <p>심사중입니다.</p>
                              <a href="${contextPath }/app/viewMyApp.do?hos_code=${hos_code}" class="barogagy">확인</a>
                            </div>
                          </c:otherwise>
                        </c:choose>
                        ${rm.rmstatus}
