      ...
      <head>
        ...
        <script type="text/javascript">
          ...
          function toList(obj) {
            ...
            obj.action = "${contextPath}/board/viewArticle.do?q_code=${article.q_code}";
            obj.submit();
          }
        </script>
        <link rel="stylesheet" href="${contextPath}/css/reset.css" />
        <link rel="stylesheet" href="${contextPath}/css/common.css" />
        <link rel="stylesheet" href="${contextPath}/css/qnaboard.css" />
        <style type="text/css">
          #btn_mod {
            display: none;
          }
      ...
      <body onload="init();">
        <div id="container_sub">
          ...
          <section class="content">
            <div class="topButton">
              <a href="${contextPath}/board/listArticles.do" class="goToList"><span>목록으로</span></a>
              <a href="#" class="goToAnswer" onclick="ans();" id="ans_btn"><span>답변하기</span></a>
            </div>
            <div class="questionContent">
              <form class="questionForm" action="${contextPath}/board/modArticle.do" name="questionForm" method="post"
                enctype="multipart/form-data">
                <fieldset>
                  <legend>질문하기 폼</legend>
                  <input type="hidden" name="q_code" value="${article.q_code}">
                  <p class="title">
                    <label class="question" for="questionTitle">질문 제목</label>
                    <input type="text" id="questionTitle" name="questionTitle" value="${article.q_title}" disabled />
                  </p>
                  <p class="info">
                  ...
                  <p class="text">
                    <label class="question" for="questionText"></label>
                    <textarea name="questionText" class="questionText" id="questionText"
                  ...
                  <div class="btn" id="btn_del">
                    ...
                    <button class="btnQuestion" type="button"
                      onclick="fn_remove_article('${contextPath}/board/removeArticle.do',${article.q_code})">질문삭제</button>
                  </div>
              ...
              <div id="answer_form">
                ...
                <form class="answerForm" action="${contextPath}/board/addReply.do"" name=" answerForm" method="post"
                  enctype="multipart/form-data">
                  <fieldset>
                    <legend>답변하기 폼</legend>
                    <input type="hidden" id="q_code" name="q_code" value="${article.q_code}">
                    <p class="title">
                      <label class="answer" for="answerTitle">답변 제목</label>
                      <input type="text" id="answerTitle" name="answerTitle" value="${article.a_title}" disabled />
                    </p>
                    <p class="check">
                      <span>채택된 답변</span>
                    ...
                    <p>
                      <label class="answer" for="answerText"></label>
                      <textarea id="answerText" name="answerText" class="questionText"
                    ...
                    <div class="btn" id="btn_del_reply">
                      ...
                      <button class="btnQuestion" type="button"
                        onclick="fn_remove_reply('${contextPath}/board/removeReply.do',${article.q_code});">답변삭제</button>
                    </div>
