  ...
  <%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
    ...
    <% request.setCharacterEncoding("utf-8"); %>
      ...
      <head>
        ...
        <link rel="stylesheet" href="${contextPath}/css/qnaboardWrite.css" />
      </head>
        ...
        <div id="container_sub">
          ...
          <section class="content">
            ...
            <div class="questionContent">
              <form class="questionForm" action="${contextPath}/board/addArticle.do" name="questionForm" method="post"
                enctype="multipart/form-data">
                <fieldset>
                  <legend>질문하기 폼</legend>
                  <p class="title">
                    <label class="question" for="questionTitle"></label>
                  ...
                  <p class="text">
                    ...
                    <textarea name="questionText" class="questionText" placeholder="내용을 입력해주세요."></textarea>
                  </p>
                  <div class="btn">
