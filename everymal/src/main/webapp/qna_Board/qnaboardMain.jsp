...
<html lang="ko">
  <head>
    ...
    <link rel="stylesheet" href="${contextPath}/css/qnaboardMain.css" />
  ...
  <body>
    <div id="container_sub">
      ...
      <section class="content">
              ...
              <c:when test="${!empty articleList}">
                <c:forEach var="article" items="${articleList}">
                  <tr>
                    <td>
                      <a
                        href="${contextPath}/board/viewArticle.do?q_code=${article.q_code}"
                        >${article.q_title}</a
                      >
                    </td>
                    <td>
                ...
                >
                  <c:if test="${not doneLoop}">
                    <c:if test="${section>1 && page==1 }">
                      <a
                        href="${contextPath}/board/listArticles.do?section=${section-1}&pageNum=${pageNum}"
                      >
                        prev</a
                      >
                    </c:if>
        ...
        <p align="center">
          <a href="${contextPath}/board/articleForm.do" class="writebtn"
            >글쓰기</a
          >
        </p>
      </section>
