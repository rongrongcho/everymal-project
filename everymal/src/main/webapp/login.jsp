        ...
        <div class="container">
          ...
          <div id="contentArea">
            <div id="loginArea">
              <section class="login">
                <!-- <h2>로그인</h2> -->
                <form action="${contextPath}/logindb/" method="post" id="frmLogin">
                  <fieldset>
                ...
                <div class="memberLink">
                  <a href="${contextPath }/join_choice.jsp" class="join">회원가입</a>
                  <a href="${contextPath }/search_id.jsp" class="find">아이디 찾기</a>
                  <a href="${contextPath }/search_pass.jsp" class="find">비밀번호 찾기</a>
                </div>
              </section>
            </div>
          </div>
