package com.myspring.stsproject.hos_List.vo;
...
public class FilterVO {
	...
	private String hos_mon;
	private String hos_tue;
	private String hos_wed;
	private String hos_thu;
	private String hos_fri;
	private String hos_sat;
	private String hos_sun;
	private String hos_sch_name;
	private int pageNum;
	private int section;
	//================롱이가 추가한 것
	...
	//======================롱이가 추가함
	public String getHos_mon() {
		return hos_mon;
	}
	public void setHos_mon(String hos_mon) {
		this.hos_mon = hos_mon;
	}
	public String getHos_tue() {
		return hos_tue;
	}
	public void setHos_tue(String hos_tue) {
		this.hos_tue = hos_tue;
	}
	public String getHos_wed() {
		return hos_wed;
	}
	public void setHos_wed(String hos_wed) {
		this.hos_wed = hos_wed;
	}
	public String getHos_thu() {
		return hos_thu;
	}
	public void setHos_thu(String hos_thu) {
		this.hos_thu = hos_thu;
	}
	public String getHos_fri() {
		return hos_fri;
	}
	public void setHos_fri(String hos_fri) {
		this.hos_fri = hos_fri;
	}
	public String getHos_sat() {
		return hos_sat;
	}
	public void setHos_sat(String hos_sat) {
		this.hos_sat = hos_sat;
	}
	public String getHos_sun() {
		return hos_sun;
	}
	public void setHos_sun(String hos_sun) {
		this.hos_sun = hos_sun;
	}
	...
	public String getHos_sch_name() {
		return hos_sch_name;
	}
	public void setHos_sch_name(String hos_sch_name) {
		this.hos_sch_name = hos_sch_name;
	}
