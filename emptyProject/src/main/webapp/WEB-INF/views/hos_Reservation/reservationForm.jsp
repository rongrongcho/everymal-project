      ...
      <%@ taglib prefix="fn" uri="http://java.sun.com/jsp/jstl/functions" %>
        <% request.setCharacterEncoding("utf-8"); %>
          ...
          <head>
            ...
            <link rel="stylesheet" type="text/css" href="${contextPath }/resources/css/reservation.css" />
              ...
              $(function () {
                document.getElementById('bringPetInfo').onclick = function () {
                  function openPopup() {
                    ...
                    openWin = window.open("${pageContext.request.contextPath}/hos_Reservation/listPopup.do", "childForm", options);
                  }
                  openPopup();
                };
                
                const urlParams = new URL(location.href).searchParams;
                const hosCode = urlParams.get('hos_code');
                const hosName = urlParams.get('hos_name');
                $('#hospitalCode').attr("value",hosCode);
                $('#hospitalName').attr("value",hosName);
              });
            </script>
          </head>
          ...
          <body>
            <div id="container_sub">
              ...
              <div class="Reservation">
                <form action="${contextPath }/hos_Reservation/reservation.do" name="reservForm" id="reservForm" method="post">
                  <input type="hidden" name="hos_code" id="hospitalCode">
                  <fieldset>
                    <legend>예약하기 폼</legend>
                    <p>
                      <label class="infoTitle" for="name">이름</label>
                      <input type="text" id="name" name="user_name" placeholder="예약자 성명" required/>
                    ...
                    <p>
                      ...
                      <input type="tel" name="tel_end" id="tel" required>
                    </p>
                    <p>
                    ...
                    <input type="text" id="hospitalName" name="hos_name" readonly />

                    <p>
                      <label class="infoTitle" for="res_date">희망 예약날짜</label>
                      <input type="date" id="datepicker" name="res_date" required/>
                    </p>
                    <p>
                      <label class="infoTitle" for="res_time">희망 예약시간</label>
                      <input type="time" id="timepicker" name="res_time" requires/>
                    </p>
                    <p>
