...
<html>
  <head>
    ...
    <link
      rel="stylesheet"
      type="text/css"
      href="${contextPath }/resources/css/reset.css"
    />
    <link
      rel="stylesheet"
      type="text/css"
    ...
    <link
      rel="stylesheet"
      type="text/css"
      href="${contextPath }/resources/css/hosApplication.css"
    />
      ...
      <section id="left_Area">
        <div class="profileBox">
          ...
          <div class="speech_bubble">
            <img
              class="bubbleImg"
              src="${contextPath}/resources/img/말풍선.svg"
              alt="말풍선 배경"
            />
            <p>
            ...
            <form id="imgForm" method="post" enctype="multipart/form-data">
              ...
              <div class="agreeform formbox">
                ...
                <input
                  type="text"
                  name="hos_name"
                  value="${hosmypageinfoVO.hos_name}"
                  readonly
                />
                <input
                  type="hidden"
                  name="hos_code"
                  value="${hosmypageinfoVO.hos_code}"
                />
              </div>
              <div class="formbox">  
                ...
                <div id="imgBox">
                  <c:choose>
                      <c:when test="${not empty hosmypageinfoVO.himg1}">
                          <img src="${contextPath}/resources/imgRepo/hos_images/thumbnail/${hosmypageinfoVO.hos_code }/${hosmypageinfoVO.himg1}" alt="이미지1" />
                      </c:when>
                      <c:otherwise>
                  ...
                  <c:choose>
                      <c:when test="${not empty hosmypageinfoVO.himg2}">
                          <img src="${contextPath}/resources/imgRepo/hos_images/thumbnail/${hosmypageinfoVO.hos_code }/${hosmypageinfoVO.himg2}" alt="이미지2" />
                      </c:when>
                      <c:otherwise>
                          <img src="${contextPath}/resources/img/noPhoto.png" alt="No Photo" />
                      </c:otherwise>
                  ...
                  <c:choose>
                      <c:when test="${not empty hosmypageinfoVO.himg3}">
                          <img src="${contextPath}/resources/imgRepo/hos_images/thumbnail/${hosmypageinfoVO.hos_code }/${hosmypageinfoVO.himg3}" alt="이미지3" />
                      </c:when>
                      <c:otherwise>
                          <img src="${contextPath}/resources/img/noPhoto.png" alt="No Photo" />
                      </c:otherwise>
 ...
 function dataSubmit() {
  ...
  $.ajax({
    ...
    url: contextPath + "/hos_MypageInfo/imgUpload.do",
    data: formData,
    processData: false,
    contentType: false,
    type: "POST",
