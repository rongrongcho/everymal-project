          ...
          <section id="tab_Area">
            ...
            <div class="tabcontents">
              ...
              <div id="tabBox" class="tab-content">
                <!-- reviewList -->
                <form action="${contextPath}/user_Page/myRevDel.do" method="post" name="del">
                  <table>
                   <colgroup>
                        <col width="10%" />
                        <col width="15%" />
                            ...
                            <tr>
                              ...
                              <td>
                                <a class="goTodetailPage"
                                  href="${contextPath}/user_Page/userViewReview.do?rv_code=${review.rv_code}">${review.rv_code}</a>
                              </td>
                              <td>
                                <c:choose>
                              ...
                              <td class="nono">
                               <div class="text-ellipsis"><a class="goTodetailPage"
                                  href="${contextPath}/user_Page/userViewReview.do?rv_code=${review.rv_code}">${review.rv_title}</a>
                              </div>
                              </td>
                      ...
                      <c:forEach var="page" begin="1" end="${tot-(section-1)*5}" step="1">
                        <c:if test="${not doneLoop}">
                          <c:if test="${section>1 && page==1 }">
                            <a href="${contextPath}/user_Page/myReview.do?section=${section-1}&pageNum=${pageNum}">
                              prev</a>
                          </c:if>
                          <c:choose>
                            <c:when test="${page==pageNum}">
                              <a class="selPage"
                                href="${contextPath}/user_Page/myReview.do?section=${section}&pageNum=${page}">${(section-1)*5+page}</a>
                            </c:when>
                            <c:otherwise>
                              <a class="noLine"
                                href="${contextPath}/user_Page/myReview.do?section=${section}&pageNum=${page}">${(section-1)*5+page}</a>
                    ...
                    <c:when test="${totReview <= 50 }">
                      ...
                      <c:forEach var="page" begin="1" end="${tot}" step="1">
                        <c:choose>
                          <c:when test="${page==pageNum}">
                            <a class="selPage"
                              href="${contextPath}/user_Page/myReview.do?section=${section}&pageNum=${page}">${page}</a>
                          </c:when>
                          <c:otherwise>
                            <a class="noLine"
                              href="${contextPath}/user_Page/myReview.do?section=${section}&pageNum=${page}">${page}</a>
