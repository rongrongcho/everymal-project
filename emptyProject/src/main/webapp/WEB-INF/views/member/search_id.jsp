                    ...
                    <fieldset>
                      ...
                      <div class="dotBox">
                        ...
                        <dl>
                          ...
                          <dt class="dot_text">
                            <label for="lb_findName2">가입자명</label>
                          </dt>
                          <dd>
                            <input disabled type="text" id="lb_findName2" class="hos_dis" name="rname2" maxlength="10"
                              class="inp3" />
                          </dd>
                          <dt class="dot_text">
                          ...
                          <dd>
                            <input type="hidden" name="C_Ident" /><input disabled type="text" id="lb_findIdent2"
                              class="hos_dis" title="사업자 등록번호 앞 세자리" name="work_no1" maxlength="3" class="inp3" />
                            -
                            <input disabled type="text" class="hos_dis" title="사업자 등록번호 가운데 두자리" name="work_no2"
                              maxlength="2" class="inp3" />
                            -
                            <input disabled type="text" class="hos_dis" title="사업자 등록번호 뒤 다섯자리" name="work_no3"
                              maxlength="5" class="inp3" />
                          </dd>
                        </dl>
                      </div>
                    </fieldset>
                    <p id="searchBtn"><button type="submit">아이디 찾기</button></p>
                  </div>
                </form>
              </div>
            </div>
            <a href="${contextPath}/member/search_pass.do" class="findPwd">비밀번호 찾기</a>
          </section>
