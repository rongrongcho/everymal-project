    ...
    <%@ taglib uri="http://java.sun.com/jsp/jstl/functions" prefix="fn" %>
      ...
      <% request.setCharacterEncoding("utf-8"); %>
        ...
        <head>
          ...
          <link rel="stylesheet" href="${contextPath}/resources/css/hosResDetail.css">
            ...
            <section id="tab_Area">
              <div class="tabcontents">
                <div id="tabBox" class="tab-content ">
                  ...
                  <form action="${contextPath }/hos_ResInfo/hosResList.do" name="reservForm" id="reservForm" method="get">
                    <fieldset>
